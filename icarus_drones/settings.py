"""
Django settings for icarus_drones project.
...
SECRET_KEY = 'django-insecure-=#zpnlnqb+ye_fo$lz+jre0b!#5xb+5!(ju!59y)g^i^m=%&$q'
...
AUTHENTICATION_BACKENDS = [
    # Needed to log in via the standard Django admin
